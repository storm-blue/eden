...
- **天降食物** 🍰: 施展后增加20000食物和2点幸福度，播放圣光降下特效和食物数字滚动动画，每天可施展3次，凌晨12点刷新次数
...
1. **保持食物充足**: 确保食物数量 >= 人口数量
2. **使用魔法**: "天降食物"魔法可以紧急补充20000食物，并增加2点幸福度
3. **合理规划**: 控制人口增长速度，避免资源短缺

### 测试饥饿机制

```bash
chmod +x test-starvation.sh
./test-starvation.sh
```

### 详细文档

- 📖 [完整饥饿机制文档](./STARVATION_MECHANISM.md)
